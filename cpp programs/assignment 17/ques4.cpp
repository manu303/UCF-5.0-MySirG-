/*
in ques1,define a method to display Time object array values. Array is received through argument.
*/
#include <iostream>
using namespace std;
...
public:
    ...
    static void displayTime(Time* timeArrayPtr,int size)
    {
        for(int i=0;i<size;i++)
        {
            cout<<"Time"<<i+1<<":";
            timeArrayPtr[i].showTime();
        }
    }
...
int main() {
    ...
    Time::displayTime(timeArrayPtr,arraySize);
    delete []timeArrayPtr;
    return 0;
}